...
srun python eval_sectionv2.py --ckpt "/project/lt200353-pcllm/3d_report_gen/CCE/checkpoints/base_augment/val_best/epoch=01-val/AUROC_macro=0.9897.ckpt" --config "./config/section.yaml" --base_output_dir "/project/lt200353-pcllm/3d_report_gen/CCE/checkpoints/base_augment/val_best/epoch=01-val/"
